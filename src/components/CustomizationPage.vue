...
<div v-if="product && category" class="max-w-5xl mx-auto px-6">
      <div class="bg-white border border-stone-100 mb-12 relative overflow-hidden shadow-sm rounded-sm">
        ...
        <div class="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-6">
          <div class="flex items-center mt-4 md:mt-0 gap-4 bg-rose-50/50 px-4 py-2 rounded-full border border-rose-100/50">
      ...
      <div class="flex justify-between items-center mb-12 border-b border-stone-100 pb-6">
        ...
        <button @click="$router.push('/')" class="text-[10px] uppercase tracking-widest font-bold border border-stone-200 px-6 py-2 hover:bg-stone-900 hover:text-white transition-all">
          Back to Shop
        </button>
      </div>
        ...
        <div class="lg:col-span-7 space-y-12">
          ...
          <section class="space-y-6">
            ...
            <div class="bg-stone-50 border border-stone-100 p-4 rounded-sm">
              <p class="text-[9px] uppercase tracking-widest text-stone-400 mb-3 font-bold text-center">Reference Catalog</p>
...
// Find product and category from catalog
